...
export const COMMITTEEHEADS: CommitteeHead[] = [
  ...
  //STAFF SPECIALIST
  {
    ...
    image:
      '../../../../../../assets/committeeHeads/committeeHeadPlaceholder.jpg',
    office: 'Office: GOL-2371',
    meetingTime: 'General Meetings: Wed • 6:30pm',
    responsibilities:
  ...
  //WEBMASTER
  {
    ...
    meetingTime: '',
    responsibilities:
      'The Webmaster is responsible for updating and maintaining the Women in Computing website and the WiCHacks website. The WiC website was revamped in 2019 by Lauren DiDonato and in 2021 by Amy Tan.',
  },
  //ALLIES
  {
    name: 'Mallory Bridge',
